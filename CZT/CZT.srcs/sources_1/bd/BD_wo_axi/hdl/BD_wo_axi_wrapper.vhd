...
end BD_wo_axi_wrapper;

architecture STRUCTURE of BD_wo_axi_wrapper is
  component BD_wo_axi is
  port (
    SSbar_0 : out STD_LOGIC;
    MOSI_0 : out STD_LOGIC;
    SCK_0 : out STD_LOGIC;
  ...
  end component BD_wo_axi;
begin
BD_wo_axi_i: component BD_wo_axi
     port map (
